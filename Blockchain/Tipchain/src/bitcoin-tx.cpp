...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Tipchain Core tipchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tipchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tipchain transaction") + "\n" +
              "  tipchain-tx [options] -create [commands]   " + _("Create hex-encoded tipchain transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tipchain transaction
